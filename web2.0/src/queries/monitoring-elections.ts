import { listMonitoredElections } from "@/services/api/monitoring-elections/list.api";
...
export const listMonitoringElectionsQueryOptions = () =>
  queryOptions({
    queryKey: monitoredElectionsKeys.list(),
    queryFn: async () => await listMonitoredElections(),
    staleTime: STALE_TIME,
    refetchOnWindowFocus: false,
  });

export const useListMonitoringElections = () =>
  useQuery(listMonitoringElectionsQueryOptions());
