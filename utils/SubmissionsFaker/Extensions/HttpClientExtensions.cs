...
namespace SubmissionsFaker.Extensions;
...
public static class HttpClientExtensions
{
        ...
        string password)
    {
        ...
        var loginResponse = authenticatedUser
            .PostWithResponse<LoginResponse>("/api/auth/login", new { email, password });
        ...
        object value)
    {
        ...
        {
            Console.Write(response.Content.ReadAsStringAsync().GetAwaiter().GetResult());
        }
