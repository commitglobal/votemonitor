...
public class ScenarioData
{
    ...
    public IPlatformAdminApi PlatformAdminClient => RestService.For<IPlatformAdminApi>(PlatformAdmin);
    ...
    public INgoAdminApi AdminApiOfNgo(ScenarioNgo name) =>  RestService.For<INgoAdminApi>(_ngos[name].Admin);
