...
public sealed class IssueReportFaker : Faker<IssueReportRequest>
{
    
    private readonly string[] _locationTypes = ["PollingStation", "OtherLocation"];

    public IssueReportFaker(List<UpdateFormResponse> forms,List<PollingStationNode> pollingStations, List<LoginResponse> observers)
    {
