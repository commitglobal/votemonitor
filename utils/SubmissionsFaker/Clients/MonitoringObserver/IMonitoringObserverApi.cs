...
public interface IMonitoringObserverApi
{
    ...
    Task<IApiResponse> SubmitAttachment([AliasAs("electionRoundId")] Guid electionRoundId,
    ...
    Task SubmitNote([AliasAs("electionRoundId")] Guid electionRoundId,
        [Body] NoteRequest note,
        [Authorize] string token);

    [Post("/api/election-rounds/{electionRoundId}/quick-reports")]
    Task SubmitQuickReport([AliasAs("electionRoundId")] Guid electionRoundId,
        [Body] QuickReportRequest quickReport,
        [Authorize] string token);

    [Multipart]
    [Post("/api/election-rounds/{electionRoundId}/quick-reports/{quickReportId}/attachments")]
    Task SubmitQuickReportAttachment([AliasAs("electionRoundId")] Guid electionRoundId,
