...
public sealed class ImportType : SmartEnum<ImportType, string>
{
    ...
    /// <returns>
    /// <c>true</c> if the <see cref="ImportType" /> contains an item with the specified name; otherwise, <c>false</c>.
    /// </returns>
    public static bool TryParse(string value, out ImportType result)
    {
