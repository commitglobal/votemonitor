import { BaseAnswer, DateAnswer, MultiSelectAnswer, NumberAnswer, RatingAnswer, SingleSelectAnswer, TextAnswer } from "@/common/types";
...
export const useFormAnswersStore = create<FormEditorAnswersContextValue>((set, get) => ({
  ...
  setAnswer: (answer: BaseAnswer | undefined) => set((state) => ({ ...state, answers: {
    ...state.answers,
