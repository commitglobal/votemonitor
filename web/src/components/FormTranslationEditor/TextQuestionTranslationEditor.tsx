...
export interface TextQuestionTranslationEditorProps {
  questionIndex: number;
}

function TextQuestionTranslationEditor({ questionIndex }: TextQuestionTranslationEditorProps) {
...
export default TextQuestionTranslationEditor;
