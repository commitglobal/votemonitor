...
export interface SelectQuestionTranslationEditorProps {
  questionIndex: number;
}

function SelectQuestionTranslationEditor({ questionIndex }: SelectQuestionTranslationEditorProps) {
...
export default SelectQuestionTranslationEditor;
