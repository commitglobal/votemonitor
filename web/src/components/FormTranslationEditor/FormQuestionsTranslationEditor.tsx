...
import PreviewQuestion from '../FormQuestionsPreview/PreviewQuestion';
import QuestionsTranslate from './QuestionsTranslationEditor';

function FormQuestionsTranslationEditor() {
  ...
  return (
    <div className='relative z-0 flex flex-1 gap-6 overflow-hidden h-[calc(100%-100px)]'>
      <main className='flex-1 h-full overflow-y-auto bg-slate-50'>
        <QuestionsTranslate activeQuestionId={activeQuestionId} setActiveQuestionId={setActiveQuestionId} />
      </main>
...
export default FormQuestionsTranslationEditor;
