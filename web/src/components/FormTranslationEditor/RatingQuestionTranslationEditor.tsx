...
export interface RatingQuestionTranslationEditorProps {
  questionIndex: number;
}

function RatingQuestionTranslationEditor({ questionIndex }: RatingQuestionTranslationEditorProps) {
...
export default RatingQuestionTranslationEditor;
