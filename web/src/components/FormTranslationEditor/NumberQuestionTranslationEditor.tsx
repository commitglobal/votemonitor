...
export interface NumberQuestionTranslationEditorProps {
  questionIndex: number;
}

function NumberQuestionTranslationEditor({ questionIndex }: NumberQuestionTranslationEditorProps) {
...
export default NumberQuestionTranslationEditor;
