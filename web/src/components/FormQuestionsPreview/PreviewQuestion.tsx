  ...
  return (
    <Card className='w-full'>
      ...
      <CardContent>
        ...
        {activeQuestionId === 'end' && <h2 className='p-4 text-2xl text-center'>Finished</h2>}
        {isNilOrWhitespace(activeQuestionId) && <h2 className='p-4 text-2xl text-center'>Select a question</h2>}
      </CardContent>
    </Card>
  );
}
