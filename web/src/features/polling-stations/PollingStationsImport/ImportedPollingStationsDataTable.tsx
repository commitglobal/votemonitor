...
import { PollingStationDataTableRowActions } from '@/components/PollingStationDataTableRowActions/PollingStationDataTableRowActions';
...
type ImportedPollingStationsDataTableProps = {
  ...
  updatePollingStation: (pollingStation: ImportPollingStationRow) => void;
  deletePollingStation: (pollingStation: ImportPollingStationRow) => void;
};

export function ImportedPollingStationsDataTable({
  data,
  updatePollingStation,
  deletePollingStation,
}: ImportedPollingStationsDataTableProps): FunctionComponent {
  const tableCols: ColumnDef<ImportPollingStationRow>[] = useMemo(
    () => [
      {
        accessorKey: 'level1',
    ...
    [updatePollingStation, deletePollingStation]
  );
