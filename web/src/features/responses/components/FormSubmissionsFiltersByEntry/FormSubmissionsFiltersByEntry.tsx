...
import { FormSubmissionFollowUpStatus, FunctionComponent, QuestionsAnswered, ZFormType } from '@/common/types';
...
import { mapFormSubmissionFollowUpStatus, mapQuestionsAnswered } from '../../utils/helpers';
      ...
      <Select
        ...
        <SelectContent>
          <SelectGroup>
            ...
            <SelectItem key={FormSubmissionFollowUpStatus.Resolved} value={FormSubmissionFollowUpStatus.Resolved}>
      ...
      {isFiltered && (
        <div className='flex flex-wrap gap-2 col-span-full'>
          ...
          {search.followUpStatus && (
            <FilterBadge
              label={`Follow-up status: ${mapFormSubmissionFollowUpStatus(search.followUpStatus)}`}
