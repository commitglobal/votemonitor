...
function Details(): FunctionComponent {
  ...
  const pushMessageData = useLoaderData({ from: '/(app)/monitoring-observers/push-messages/$id' });
...
export const Route = createFileRoute('/(app)/monitoring-observers/push-messages/$id')({
  component: Details,
