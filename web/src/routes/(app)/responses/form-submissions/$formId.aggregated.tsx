...
export const SubmissionsAggregatedByFormSchema = z
  .object({
...
export const Route = createFileRoute('/(app)/responses/form-submissions/$formId/aggregated')({
  beforeLoad: () => {
    redirectIfNotAuth();
  },
