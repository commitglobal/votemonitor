...
public class CreateValidatorTests
{
    ...
    {
        // Arrange
        var model = new Create.Request { GuideType = CitizenReportGuideType.Document, Attachment = null };
    ...
    {
        // Arrange
        var model = new Create.Request { GuideType = CitizenReportGuideType.Website, WebsiteUrl = string.Empty };
    ...
    {
        // Arrange
        var model = new Create.Request { GuideType = CitizenReportGuideType.Text, WebsiteUrl = string.Empty };
