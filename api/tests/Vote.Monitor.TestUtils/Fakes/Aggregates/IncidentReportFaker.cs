...
public sealed class IncidentReportFaker : PrivateFaker<IncidentReport>
{
    public IncidentReportFaker(Guid? id = null,
        ...
        Form? form = null)
    {
        ...
        RuleFor(fake => fake.LocationType, IncidentReportLocationType.OtherLocation);
