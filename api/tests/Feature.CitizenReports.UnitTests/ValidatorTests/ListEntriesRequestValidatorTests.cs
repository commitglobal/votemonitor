...
public class ListEntriesRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new ListEntries.Request { NgoId = Guid.Empty };
    ...
    {
        // Arrange
        var request = new ListEntries.Request { ElectionRoundId = Guid.Empty };
