...
public class UpdateStatusRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new UpdateStatus.Request { NgoId = Guid.Empty };
    ...
    {
        // Arrange
        var request = new UpdateStatus.Request { ElectionRoundId = Guid.Empty };
    ...
    {
        // Arrange
        var request = new UpdateStatus.Request { Id = Guid.Empty };
