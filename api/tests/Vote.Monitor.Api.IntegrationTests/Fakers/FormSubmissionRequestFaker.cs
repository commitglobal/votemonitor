...
public sealed class FormSubmissionRequestFaker : Faker<FormSubmissionRequest>
{
    public FormSubmissionRequestFaker(Guid formId, Guid pollingStationId, List<BaseQuestionRequest> questions)
    {
        Rules((f, x) =>
        {
