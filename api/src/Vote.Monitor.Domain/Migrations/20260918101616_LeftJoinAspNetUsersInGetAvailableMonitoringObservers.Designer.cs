...
namespace Vote.Monitor.Domain.Migrations
{
    ...
    [Migration("20260918101616_LeftJoinAspNetUsersInGetAvailableMonitoringObservers")]
    partial class LeftJoinAspNetUsersInGetAvailableMonitoringObservers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.CitizenReportCommentAggregate.CitizenReportComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ElectionRoundId", "CitizenReportId");

                    b.ToTable("CitizenReportComments", (string)null);
                });
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.CoalitionAggregate.CoalitionGuideAccess", b =>
                {
                    ...
                    b.HasKey("CoalitionId", "MonitoringNgoId", "GuideId");

                    b.HasIndex("GuideId");

                    b.HasIndex("MonitoringNgoId");

                    b.ToTable("CoalitionGuideAccess");
                });
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.ElectionRoundFormTemplateAggregate.ElectionRoundFormTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ElectionRoundId", "FormTemplateId")
                        .IsUnique();

                    b.ToTable("ElectionRoundFormTemplates");
                });
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.FormSubmissionCommentAggregate.FormSubmissionComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ElectionRoundId", "SubmissionId");

                    b.ToTable("FormSubmissionComments", (string)null);
                });
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.IncidentReportCommentAggregate.IncidentReportComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ElectionRoundId", "IncidentReportId");

                    b.ToTable("IncidentReportComments", (string)null);
                });
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.QuickReportCommentAggregate.QuickReportComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("QuickReportId");

                    b.HasIndex("ElectionRoundId", "QuickReportId");

                    b.ToTable("QuickReportComments", (string)null);
                });
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.CoalitionAggregate.CoalitionGuideAccess", b =>
                {
                    b.HasOne("Vote.Monitor.Domain.Entities.CoalitionAggregate.Coalition", "Coalition")
                        .WithMany("GuideAccess")
                        .HasForeignKey("CoalitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vote.Monitor.Domain.Entities.ObserverGuideAggregate.ObserverGuide", "Guide")
                        .WithMany()
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.ElectionRoundFormTemplateAggregate.ElectionRoundFormTemplate", b =>
                {
                    ...
                    b.HasOne("Vote.Monitor.Domain.Entities.FormTemplateAggregate.FormTemplate", "FormTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.FormSubmissionCommentAggregate.FormSubmissionComment", b =>
                {
                    ...
                    b.HasOne("Vote.Monitor.Domain.Entities.FormSubmissionAggregate.FormSubmission", "Submission")
                        .WithMany()
            ...
            modelBuilder.Entity("Vote.Monitor.Domain.Entities.QuickReportCommentAggregate.QuickReportComment", b =>
                {
                    ...
                    b.HasOne("Vote.Monitor.Domain.Entities.QuickReportAggregate.QuickReport", "QuickReport")
                        .WithMany()
                        .HasForeignKey("QuickReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ElectionRound");

                    b.Navigation("QuickReport");
                });
