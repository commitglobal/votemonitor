    ...
    VoteMonitorContext context) : Endpoint<Request, Results<NoContent, NotFound>>
{
    public override void Configure()
    {
        ...
        Summary(s =>
        {
            s.Summary = "Removes tags from selected monitoring observers";
        });
    }
    ...
    public override async Task<Results<NoContent, NotFound>> ExecuteAsync(Request req, CancellationToken ct)
    {
        ...
        await context
            ...
            .ExecuteUpdateAsync(x => x.SetProperty(p => p.Tags, b => Postgres.Functions.ArrayDiff(b.Tags, req.Tags)), cancellationToken: ct);
