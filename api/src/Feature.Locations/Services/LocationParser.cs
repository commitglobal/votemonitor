...
public class LocationParser : ILocationsParser
{
    ...
    public LocationParsingResult Parse(Stream stream)
    {
        ...
        catch (HeaderValidationException e)
        {
            ...
            return new LocationParsingResult.Fail(new ValidationFailure("Header", "Invalid header provided in import locations file."));
        }
        catch (CsvHelper.MissingFieldException e)
        {
            SentrySdk.CaptureException(e);
            _logger.LogError(e, "Malformed csv provided.");
            return new LocationParsingResult.Fail(new ValidationFailure("Csv File", "Malformed import locations file provided."));
        }
