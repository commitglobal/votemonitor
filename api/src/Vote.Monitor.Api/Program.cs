...
using Feature.Form.Submission.Comments;
using Feature.Forms;
...
using Feature.PollingStation.Information.Forms;
using Feature.PollingStation.Visits;
using Feature.QuickReports;
using Feature.QuickReports.Comments;
using Microsoft.AspNetCore.ResponseCompression;
using NSwag;
using Feature.Ngos;
using Feature.NgoAdmins;
...
using Feature.CitizenReports.Comments;
...
using Feature.IncidentReports.Comments;
...
builder.Services.AddPollingStationVisitsFeature();
builder.Services.AddMonitoringObserversFeature();
builder.Services.AddFormSubmissionsFeature();
builder.Services.AddFormSubmissionCommentsFeature();
builder.Services.AddQuickReportsFeature();
builder.Services.AddQuickReportsCommentsFeature();
...
builder.Services.AddCitizenReportsCommentsFeature();
...
builder.Services.AddIncidentReportsCommentsFeature();
