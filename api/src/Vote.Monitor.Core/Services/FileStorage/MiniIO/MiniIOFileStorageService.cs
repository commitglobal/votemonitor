...
internal class MiniIOFileStorageService(IAmazonS3 client,
    ILogger<MiniIOFileStorageService> logger,
    IOptions<MiniIOOptions> options) : IFileStorageService
{
    private readonly MiniIOOptions _options = options.Value;
